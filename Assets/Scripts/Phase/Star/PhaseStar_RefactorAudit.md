...
| PhaseStar.cs | safety-bubble runtime/static state fields | Dead candidate (confirmed) | High | Bubble system removed from star design; fields deleted, query methods kept inert for compatibility. |
...
| PhaseStarCravingNavigator.cs | role targeting timers | Live | High | Replan/sniffer used for nearest-attuned-role dust targeting. |
